        ...
        <div className={styles.main} ref={contentRef}>
            ...
            <div
                ...
                <div className={workStyles.workPageHeaderContainer}>
                    <h1 className={workStyles.workHeaderText} style={{color:"#000"}}>Creatorverse</h1>
                </div>
                <div className={workStyles.parallaxLayer} ref={bgRef}>
                    <picture>
                    <source
                        media="(min-width: 769px)"
                        srcSet="/assets/creatorversecover-desktop.png 1x, /assets/creatorversecover-desktop.png 2x"
                    />
                    <img
                        className={workStyles.parallaxImg}
                        src="/assets/creatorversepreview.png"
                        alt="creatorverse cover"
                        loading="eager"
                        fetchpriority="high"
                    />
                    </picture>
                    ...
                    <div className={workStyles.workInfoTextWrapper}>
                        <p className={catalogStyles.catalogItemSubtext} style={{color:"#aaa", fontWeight:"600"}}> 
                         ...
                         <p className={catalogStyles.catalogItemSubtext} style={{color:"#fff"}}> 
                            Brand revamp partner. Website performance optimizer. Portfolio and identity designer.
                        </p>
                    </div>
                    <div className={workStyles.workInfoTextWrapper}>
                        <p className={catalogStyles.catalogItemSubtext} style={{color:"#aaa", fontWeight:"600"}}> 
                         ...
                         <p className={catalogStyles.catalogItemSubtext} style={{color:"#fff"}}> 
                            Revamped Logo {'&'} Branding, Portfolio Showcase, Conversion Strategies
                        </p>
                    </div>
                    <div className={workStyles.workInfoTextWrapper}>
                        <p className={catalogStyles.catalogItemSubtext} style={{color:"#aaa", fontWeight:"600"}}> 
                    ...
                    <div className={workStyles.workInfoTextWrapper}>
                        <p className={catalogStyles.catalogItemSubtext} style={{color:"#aaa", fontWeight:"500"}}> 
                         ...
                         <p className={catalogStyles.catalogItemSubtext} style={{color:"#fff", fontWeight:"300"}}> 
                            Blackprint partnered with Creatorverse to revamp a dull identity into something fun, preppy, and creator focused. A new logo, branding system, and website were launched alongside backend optimization to make the platform fast and reliable.
                        </p>
                        <ContextItem subtext={"The project required balancing personality with performance. The goal was a design that felt fresh and sticky while still delivering top tier speed and reliability."}
                        title={true}/>
                    </div>
                </div>
            </section>
            ...
            <section className={workStyles.workInfoSection}>
                ...
                <div className={workStyles.workInfoContainer}>
                    <div className={workStyles.workInfoTextWrapper} style={{gap:".375rem"}}>
                        <p className={catalogStyles.catalogItemSubtext} style={{color:"#fff", fontWeight:"400"}}> 
                            Bringing Fun Into Design
                        </p>
                         <p className={catalogStyles.catalogItemSubtext} style={{color:"#fff", fontWeight:"300"}}> 
                            The client wanted a new look that felt approachable and engaging.
                        </p>
                    </div>
                     <div className={workStyles.workInfoTextWrapper} style={{gap:".375rem"}}>
                        <p className={catalogStyles.catalogItemSubtext} style={{color:"#fff", fontWeight:"400"}}> 
                         ...
                         <p className={catalogStyles.catalogItemSubtext} style={{color:"#fff", fontWeight:"300"}}> 
                            Logo, typography, and color needed a complete update to align with the brand’s creator focused energy.
                        </p>
                    </div>
                     <div className={workStyles.workInfoTextWrapper} style={{gap:".375rem"}}>
                        <p className={catalogStyles.catalogItemSubtext} style={{color:"#fff", fontWeight:"400"}}> 
                         ...
                         <p className={catalogStyles.catalogItemSubtext} style={{color:"#fff", fontWeight:"300"}}> 
                           A site that performed quickly was critical to reduce bounce rates and support engagement.
                        </p>
                    </div>
                    <div className={workStyles.workInfoTextWrapper} style={{gap:".375rem"}}>
                        <p className={catalogStyles.catalogItemSubtext} style={{color:"#fff", fontWeight:"400"}}> 
                         ...
                         <p className={catalogStyles.catalogItemSubtext} style={{color:"#fff", fontWeight:"300"}}> 
                           The platform needed features that converted visitors into leads.
                        </p>
                    </div>
                </div>
            </section>
                ...
                <div className={workStyles.workInfoContainer}>
                    <div className={workStyles.workInfoTextWrapper} style={{gap:".375rem"}}>
                        <p className={catalogStyles.catalogItemSubtext} style={{color:"#fff", fontWeight:"400"}}> 
                         ...
                         <p className={catalogStyles.catalogItemSubtext} style={{color:"#fff", fontWeight:"300"}}> 
                            Research into other platforms clarified where Creatorverse could stand apart.
                        </p>
                    </div>
                     <div className={workStyles.workInfoTextWrapper} style={{gap:".375rem"}}>
                        <p className={catalogStyles.catalogItemSubtext} style={{color:"#fff", fontWeight:"400"}}> 
                            Playful Branding System
                        </p>
                         <p className={catalogStyles.catalogItemSubtext} style={{color:"#fff", fontWeight:"300"}}> 
                            A fun and preppy design language was introduced to highlight personality.
                        </p>
                    </div>
                     <div className={workStyles.workInfoTextWrapper} style={{gap:".375rem"}}>
                        <p className={catalogStyles.catalogItemSubtext} style={{color:"#fff", fontWeight:"400"}}> 
                            Logo and Website Overhaul
                        </p>
                         <p className={catalogStyles.catalogItemSubtext} style={{color:"#fff", fontWeight:"300"}}> 
                           The identity was rebuilt with a new logo and a site that felt quick, modern, and memorable.
                        </p>
                    </div>
                    <div className={workStyles.workInfoTextWrapper} style={{gap:".375rem"}}>
                        <p className={catalogStyles.catalogItemSubtext} style={{color:"#fff", fontWeight:"400"}}> 
                         ...
                         <p className={catalogStyles.catalogItemSubtext} style={{color:"#fff", fontWeight:"300"}}> 
                           Backend systems were tested for latency and fine tuned for speed.
                        </p>
                    </div>
                    <div className={workStyles.workInfoTextWrapper} style={{gap:".375rem"}}>
                        <p className={catalogStyles.catalogItemSubtext} style={{color:"#fff", fontWeight:"400"}}> 
                         ...
                         <p className={catalogStyles.catalogItemSubtext} style={{color:"#fff", fontWeight:"300"}}> 
                           A curated section was created to engage visitors and incentivize sign ups.
                        </p>
                    </div>
                </div>
            </section>
                ...
                <div className={workStyles.workInfoContainer}>
                    <div className={workStyles.workInfoTextWrapper} style={{gap:".375rem"}}>
                        <p className={catalogStyles.catalogItemSubtext} style={{color:"#fff", fontWeight:"400"}}> 
                         ...
                         <p className={catalogStyles.catalogItemSubtext} style={{color:"#fff", fontWeight:"300"}}> 
                            The refreshed brand led to collaborations with Stan, Framer, and Adobe.
                        </p>
                    </div>
                     <div className={workStyles.workInfoTextWrapper} style={{gap:".375rem"}}>
                        <p className={catalogStyles.catalogItemSubtext} style={{color:"#fff", fontWeight:"400"}}> 
                         ...
                         <p className={catalogStyles.catalogItemSubtext} style={{color:"#fff", fontWeight:"300"}}> 
                            The newsletter reached 22,000 monthly visitors and the site gained 5,000 unique visitors in just two weeks.
                        </p>
                    </div>
                     <div className={workStyles.workInfoTextWrapper} style={{gap:".375rem"}}>
                        <p className={catalogStyles.catalogItemSubtext} style={{color:"#fff", fontWeight:"400"}}> 
                         ...
                         <p className={catalogStyles.catalogItemSubtext} style={{color:"#fff", fontWeight:"300"}}> 
                           Over 200 new leads were generated through the updated design and portfolio system..
                        </p>
                    </div>
                </div>
            </section>
